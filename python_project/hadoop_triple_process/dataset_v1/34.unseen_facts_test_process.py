...
def split_unseen_relation_test(unseen_relation_test_path):
    ...
    u_relation_test_inverse = read_files("./new_dataset/new_dataset_v1/unseen_relation_test_1892_forward.txt")
    u_relation_test_others = read_files("./new_dataset/new_dataset_v1/unseen_relation_test_1892_others.txt")
    ...
    write_triples_2_id("./new_dataset/new_dataset_v1/unseen_relation_inverse_test.txt",unseen_relation_inverse_test)
    write_triples_2_id("./new_dataset/new_dataset_v1/unseen_relation_others_test.txt",unseen_relation_others_test)
...
def obtain_trple2id(entity2id_dic,relation2id_dic,unseen_relation_inverse_test,unseen_relation_others_test):
    ...
    for _data in test_data:
        ...
        write_data_2_id("./new_dataset/new_dataset_v1/" + test_data_name[index] +"2id.txt" ,data2id)
        index +=1
...
if __name__ == "__main__":
    ...
    entity2id_path = "./new_dataset/new_dataset_v1/entity2id.txt"
    relation2id_path = "./new_dataset/new_dataset_v1/relation2id.txt"
    entity2id_dic,relation2id_dic = get_entity_relation_2id(entity2id_path,relation2id_path)


    unseen_relation_test_path = "./new_dataset/new_dataset_v1/unseen_relation_test.txt"
