...
def split_unseen_relation_test(unseen_relation_test_path):
    ...
    write_triples_2_id("./new_dataset/new_hadoop_data_process/unseen_relation_inverse_test.txt",unseen_relation_inverse_test)
    write_triples_2_id("./new_dataset/new_hadoop_data_process/unseen_relation_others_test.txt",unseen_relation_others_test)
...
if __name__ == "__main__":
    ...
    _train = read_files('./hadoop_data_with_time/test_triple_constructed_with_unseen_entity.txt')
