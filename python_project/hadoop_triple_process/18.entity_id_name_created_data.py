...
def write_id_name_created_date(out_path,data):
...
if __name__ == "__main__":
    ...
    for i in range(row):
        print(i)
        _id_name_created_date = []
        Id = entity_des2[i][1]

        Name = clean(entity_des2[i][2])
        Name = ' '.join(Name)

        # create_date = creted_time_process(entity_des2[i, 4])
        create_date = entity_des2[i, 4]
        ...
        _id_name_created_date.append(Id)
        _id_name_created_date.append(Name)
        _id_name_created_date.append(create_date)

        id_name_mention.append(_id_name_created_date)
        # print("id_name_mention",id_name_mention)

    print("len(id_name_mention)",len(id_name_mention))
    write_id_name_created_date("./hadoop_with_other_components/total_entity_ID_Name_with_time.txt", id_name_mention)
